...
class ProductController extends AbstractController
{
    ...
    {
        $posts = [
            ["id" => 1, "title"=>"PARIS BY NIGHT", "image"=>"image1.jpg", "description"=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book", "date_post"=>"18/08/2021" ],
            ...
            ["id" => 3, "title"=>"PARIS BY DAY", "image"=>"image3.jpg", "description"=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book", "date_post"=>"11/08/2021" ],
        ];
